...
See [CHANGELOG.md](TASTE-SKILL-CHANGELOG.md) for the full v1 to v2 diff and the rationale.
...
- Start with **taste-skill** for the safest general default. (Now v2 experimental - see what changed in the [CHANGELOG](TASTE-SKILL-CHANGELOG.md).)
...
[MIT License](TASTE-SKILL-LICENSE) · Copyright (c) 2026 Leonxlnx
